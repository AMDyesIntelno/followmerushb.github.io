...
当前`S/N`为`2^(35/3.1)-1=2503`,信噪比为`10*lg(S/N)=33.98(dB)`

目标`S/N`为`2^(35*1.6/3.1)-1=274131`,信噪比为`10*lg(S/N)=54.37(dB)`

`S/N`应增大`100`倍

目标`S/N`为`2741310`,传输速率为`W*log(2)(1+S/N)=3100*21.38=66278`
